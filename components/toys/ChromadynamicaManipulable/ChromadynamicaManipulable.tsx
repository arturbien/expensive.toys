...
`;
const Wrapper = styled.div<{ sizeRatio: number }>`
  grid-area: 1 / 1;
  align-self: center;
  justify-self: center;
  width: 100%;
  ...
  /* background: url(https://img.freepik.com/free-photo/portrait-white-man-isolated_53876-40306.jpg);
    ...
    <>
      ...
      {step < steps - 1 ? (
        <AngleContext.Provider value={resultAngle}>
          <Segment steps={steps} step={step + 1} sizeRatio={sizeRatio} />
